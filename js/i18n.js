const dictionaries = {
  ru: {
    ...
    pvp: {
      ...
      filterAll: "Все карты",
      filterTie: "Ничьи",
      prediction: "Matchmaking Prediction"
    },
    tas: {
      title: "TAS Ban List",
    ...
    pvp: {
      ...
      kicker: "HEAD-TO-HEAD // DUEL MODE",
      placeholder1: "Первый игрок (stone)",
      placeholder2: "Второй игрок (m09l6d0ur13ii)",
      compareBtn: "Начать дуэль ⚔️",
      loading: "Загрузка данных дуэли...",
      predictionTitle: "ПРЕДСКАЗАНИЕ МАТЧА",
      predictionLead: "лидирует с преимуществом в",
      predictionEqual: "Шансы равны 50% / 50%",
      winnerBannerLead: "лидирует с преимуществом в",
      winnerBannerTied: "Ничья! Одинаковое количество побед на общих картах",
      winnerCardBadge: "ПОБЕДИТЕЛЬ",
      duelScore: "СЧЁТ ДУЭЛИ",
      commonMaps: "Общих карт",
      leadMaps: "карт",
      tiesCount: "Ничьих",
      mapsWon: "ПОБЕД НА КАРТАХ",
      winRate: "WR",
      filterAll: "Все карты",
      filterTies: "Ничьи",
      tableHeaderMap: "Карта",
      tableHeaderServer: "Сервер",
      tableHeaderWinner: "Победитель",
      duelTable: "Дуэль на общих картах",
      searchPlaceholder: "Поиск по названию карты...",
      map: "Карта",
      server: "Сервер",
      time: "Время",
      diff: "Разница",
      equal: "Ничья",
      noCommonMaps: "Нет общих пройденных карт для отображения",
      errorDiff: "Пожалуйста, выберите двух разных игроков для дуэли",
      errorFetch: "Не удалось загрузить данные одного из игроков",
      errorBlacklist: "Один из игроков находится в чёрном списке (TAS / Читы)",
      specComparison: "Сравнение по категориям",
      p1Faster: "Быстрее",
      p2Faster: "Быстрее",
      ptsAdvantage: "Преимущество по очкам",
      avgLead: "Средний отрыв",
      soloOnTeam: "— (Соло)",
    },
    settings: {
      title: "Настройки пользователя",
  ...
  en: {
    ...
    pvp: {
      title: "Player vs Player (PvP)",
      kicker: "HEAD-TO-HEAD // DUEL MODE",
      placeholder1: "First player (stone)",
      placeholder2: "Second player (m09l6d0ur13ii)",
      compareBtn: "Start Duel ⚔️",
      loading: "Loading duel data...",
      predictionTitle: "MATCHMAKING PREDICTION",
      predictionLead: "leads by",
      predictionEqual: "Chances are equal 50% / 50%",
      winnerBannerLead: "leads with an advantage of",
      winnerBannerTied: "Tied! Equal number of map wins",
      winnerCardBadge: "WINNER",
      duelScore: "DUEL SCORE",
      commonMaps: "Shared Maps",
      leadMaps: "maps",
      tiesCount: "Ties",
      mapsWon: "MAP WINS",
      winRate: "WR",
      ...
      diff: "Difference",
      equal: "Tie",
      noCommonMaps: "No shared completed maps to display",
      errorDiff: "Please choose two different players to duel",
      errorFetch: "Failed to load data for one of the players",
      errorBlacklist: "One of the players is blacklisted (TAS / Cheating)",
      specComparison: "Category Breakdown",
      p1Faster: "Faster",
      p2Faster: "Faster",
      ptsAdvantage: "PTS Advantage",
      avgLead: "Average Lead",
      soloOnTeam: "— (Solo)",
    },
    settings: {
      title: "User Settings",
